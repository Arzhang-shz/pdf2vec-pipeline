...
def main():
    parser = argparse.ArgumentParser(description="Process PDF, generate embeddings, and save to MongoDB and FAISS.")
    parser.add_argument("pdf_path", help="Path to the PDF file")
    parser.add_argument("--faiss_index_path", default="faiss_index.faiss", help="Path to the FAISS index file")
    ...
    for chunk in chunks:
        try:
            ...
            metadata = {"pdf_path": pdf_path}  # Add relevant metadata
